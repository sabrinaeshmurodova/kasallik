...
if st.button("Predict Heart Disease"):
    user_input = [
        AGE, SMOKING, YELLOW_FINGERS, ANXIETY, PEER_PRESSURE, CHRONIC_DISEASE, WHEEZING,  COUGHING, ALCOHOL_CONSUMING, SHORTNESS_OF_BREATH, SWALLOWING_DIFFICULTY, CHEST_PAIN
    ]
